...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "helloboot@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "helloboot API";

        private String description = "helloboot API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "helloboot";
